...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`${message.author} **| Alınacak Rolü Etiketlemelisin.** <a:crosss:1030583088130035812>`)
  .setColor("BLACK")
  ...
  let user = message.mentions.users.first();
    ...
    .setDescription(`${user} **Adlı Kullanıcıdan** ${rol} **Rolünü Aldım.** <a:tickpiola:1030784957121056819>`)
    .setColor("BLACK")
